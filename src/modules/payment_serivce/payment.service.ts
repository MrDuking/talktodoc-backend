...
import { PaymentUrlResponse, PaymentVerificationResponse, VnpayParams } from "./interfaces/payment.interface"
...
export class PaymentService {
    ...
    async createPaymentUrl(request: PaymentRequestDto): Promise<PaymentUrlResponse> {
        ...
        try {
            ...
            this.logger.error(`Error creating payment URL: ${error instanceof Error ? error.message : "Unknown error"}`, error instanceof Error ? error.stack : undefined)
            throw error
        }
    }

    // Simplified callback processing
    async processSimpleCallback(callbackData: PaymentCallbackDto): Promise<PaymentVerificationResponse> {
        try {
    ...
    async getAllOrders() {
        try {
            ...
            this.logger.error(`Error getting all orders: ${error instanceof Error ? error.message : "Unknown error"}`, error instanceof Error ? error.stack : undefined)
            throw error
        }
    }
